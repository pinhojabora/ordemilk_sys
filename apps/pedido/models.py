...
class Pedido(models.Model):
    ...
    data_pedido = models.DateField(default=datetime.today, blank=False)
...
class Item_pedido(models.Model):
    ...
    produto = models.ForeignKey(Produto, on_delete=models.CASCADE, null=True, blank=False, related_name='pedidos')
